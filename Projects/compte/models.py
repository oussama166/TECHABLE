...
class Video_cour(models.Model):
    ...
    video2 = models.FileField(upload_to='videos/', default='videos/hawaii_blue_water_4K.mp4')
    title3 = models.CharField(max_length=100)
    description3 = models.TextField()
    video3= models.FileField(upload_to='videos/', default='videos/hawaii_blue_water_4K.mp4')
    title4 = models.CharField(max_length=100)
    description4 = models.TextField()
    video4 = models.FileField(upload_to='videos/', default='videos/hawaii_blue_water_4K.mp4')
    title5 = models.CharField(max_length=100)
    description5 = models.TextField()
    video5 = models.FileField(upload_to='videos/', default='videos/hawaii_blue_water_4K.mp4')
